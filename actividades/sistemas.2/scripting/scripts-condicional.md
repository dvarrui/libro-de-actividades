...
* [if-ejemplo1-mkdir.sh](files/condicional/if-ejemplo1-mkdir.sh)
* [if-ejemplo2-rm.sh](files/condicional/if-ejemplo2-rm.sh)
* [if-ejemplo3-mkdir.sh](files/condicional/if-ejemplo3-mkdir.sh)
* [if-ejemplo4-rm.sh](files/condicional/if-ejemplo4-rm.sh)
* [if-ejemplo5-ruby.rb](files/condicional/if-ejemplo5-ruby.rb)
* [if-ejemplo6-ruby.rb](files/condicional/if-ejemplo6-ruby.rb)
...
exits# 2. Crear usuarios y borrar usuarios en GNU/Linux
...
* Ejecutar el script de borrado.
* Consultar la lista de usuarios.
tatus = `echo $?`.to_i   # exitstatus is 1
