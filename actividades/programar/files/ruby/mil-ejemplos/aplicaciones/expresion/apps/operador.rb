...
class Operador
  ...
  #Devuelve +true+ si el parámetro es un +String+ con un operador válido.
  def operador?(p)
    return true if @operadores.index(p)
    false
  end

  #Devuelve +true+ si el parámetro es un +String+ con un número.
  def numero?(p)
  ...
  #Devuelve +true+ si el parámetro es un +String+ con un paréntesis.
  def parentesis?(p)
    return true if (p=='(' || p==')')
    false
  end
 
  #Devuelve un +String+ con el resultado de evaluar el operador expresion[index].
  #Debemos tener en cuenta que:
  #1. _index_ es un valor numérico que identifica un elemento del vector expresión.
  #2. _expresion_ es un vector que contiene como elementos cada uno de los componentes de la expresión.
  #3. _traza_ es un vector que contiene un registro de las operaciones realizadas.
  #
