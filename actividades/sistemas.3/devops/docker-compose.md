...
* Usar contenedores Docker creados a partir de un Dockerfile.
* Docker-compose para gestionar conjuntos de contendores.
...
Esta herramienta nos permite crear contenedores, lo cual son aplicaciones empaquetadas auto-suficientes, muy livianas, que son capaces de funcionar en prácticamente cualquier ambiente, ya que tiene su propio sistema de archivos, librerías, terminal, etc.
...
* Asegurarse de activar IP_FORWARD (Habilitar reenvío):
    * Modificando el contenido de `net.ipv4.ip_forward`.
    * O usando Yast.
