...
class TestAffinityTrip < Test::Unit::TestCase
  ...
  def data(name)
    IO.read(TestUtil::test_data(name))
  end
  ...
  def test_book_info_can_be_scraped_out
    ...
    actual = scrape_book_info(data('programming-ruby-amazon-page.html'))
  ...
  def test_book_title_that_spans_lines_can_be_scraped_out
    actual = scrape_book_info(data('cell-amazon-page.html'))
  ...
  def test_book_info_with_extra_text_after_authors_gets_authors_right
    ...
    actual = scrape_book_info(data('professional-ajax-amazon-page.html'))
  ...
  def test_affinity_list_can_be_scraped_out
    list = scrape_affinity_list(data('programming-ruby-amazon-page.html'))
