...
public class Parametros {
	...
	public final static String DIR_BASE = "bin/";	// TODO:Cambiar en la versión definitiva
	...
	public final static String JSF = "jsf";
	
	public final static String SQL = "sql";

	public final static String PROYECTO = "proyecto.name";

	public final static String valoresCS = "["+JAVA+"]["+JSF+"]["+JSP+"]["+PHP+"]["+SQL+"][all]";
	...
	public Parametros() {
		...
		param.put(INPUT_MODE, "fichero");
		param.put(DIR_SALIDA, "tmp");
		param.put(CODE_SALIDA, "all");
		param.put(PROYECTO, "proyecto");
