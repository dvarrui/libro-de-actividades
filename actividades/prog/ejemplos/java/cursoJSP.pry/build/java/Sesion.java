 ...
 * de la base de datos (objeto del tipo <b>Conexion</b>)
 *
 ...
 */
public class Sesion extends Object
{
    ...
    */
   public void inicializar(Conexion p_bd)
   {
   ...
   //===================================================
   public Capa1Predicado crearCapa1Predicado()
   {
      if (cod_estado==LOGIN)
      {   Capa1Predicado r = new Capa1Predicado(); r.inicializar(this); return r; }
      return null;
   }
}
//Fin de la clase Sesion.java
