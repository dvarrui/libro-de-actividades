 ...
 * @version 0.8.1
 */
public class WFBD extends Object
{
    ...
    * @return Un objeto del tipo <b>WFSesion</b> que representa la sesión.
    */
   public WFSesion crearSesion()
   {
      if (cod_estado==CONECTADO)
      {
         //return new WFSesion(this);
	 WFSesion s = new WFSesion(); s.inicializar(this);
	 return s;
      }
      return null;
   }
   ...
   public boolean desconectar()
   {
      ...
      catch (Exception e)  { System.err.println("Exception en WFBD.desconectar(): " + e);}
      return false;
   }
