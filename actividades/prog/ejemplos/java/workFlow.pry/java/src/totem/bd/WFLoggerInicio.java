 ...
 * @version 0.7.2
 */
class WFLoggerInicio extends Object
{
   ...
   //=======================
   WFLoggerInicio(Connection p_con)
   {
      con=p_con;
      usuario=new String("crearBD"); pc=null; modulo=new String("*");
   }
   ...
   {   
	 ...
	 st1.executeUpdate("INSERT INTO LOG_D_AVISOS (TIPO,USUARIO,PC,MODULO,DESCRIPCION) VALUES('"
      ...
      {  System.err.println("ERROR en WFLoggerInicio.registrar(): "+e+",<"+str+">"); }
      return false;
   }
}
//Fin de la clase WFLoggerInicio.java
