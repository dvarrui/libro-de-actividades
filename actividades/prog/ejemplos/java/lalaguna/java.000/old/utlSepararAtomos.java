 ...
 * @version 0.1.0
*/
public class utlSepararAtomos extends Object
{
   ...
   //Constructor
   //===========
   public utlSepararAtomos(String str)
   ...
   /**
    * @return devuelve falso si quedan atomos pendientes de extraer
    */
   public boolean fin()
   {
