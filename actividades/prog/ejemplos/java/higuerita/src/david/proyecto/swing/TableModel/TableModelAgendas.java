...
// Comienza la clase
public class TableModelAgendas extends AbstractTableModel {
   ...
   // Constructor
   public TableModelAgendas(IAlmacen pAlmacen) {
      setAlmacen(pAlmacen);
   }
   ...
   public int getColumnCount() {
      return (new Agendas()).getNumeroCampos();
   }
   ...
   public String getColumnName(int index) {
      return Agendas.getNombreCampo(index);
   }
   ...
   public Object getValueAt(int fila, int col) {
      Agendas reg = (Agendas) datos.get(fila);
