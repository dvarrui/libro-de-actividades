...
import david.proyecto.swing.TableModel.TableModelPersonas;

// Comienzo de la clase
public class FrmListadoPersonas extends javax.swing.JInternalFrame implements ActionListener, IVentana {
   static final long serialVersionUID=1; //Para evitar Warnings

   // Atributos
   public static final String ID_VENTANA="personas.listado";
   ...
   private TableModelPersonas modeloDeTabla;
   private IAlmacen almacen;
   
   // Constructor
   public FrmListadoPersonas(IAlmacen pAlmacen) {
      super();
      setAlmacen(pAlmacen);
      initGUI();
   }
   ...
   public void actionPerformed(ActionEvent evt) {
      if (evt.getActionCommand().equals("personas.nuevo")) {
         // Abrir ventana Nuevo
      } else if (evt.getActionCommand().equals("personas.consultar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("personas.modificar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("personas.eliminar")) {
         this.setVisible(false);
            ...
            {
               {
                  ...
                  pnlVentana.add(pnlBotones, BorderLayout.SOUTH);
                  {
                     ...
                     btnNuevo.setActionCommand("personas.nuevo");
                  ...
                  }
                  {
                     ...
                     btnConsultar.setActionCommand("personas.consultar");
                  ...
                  }
                  {
                     ...
                     btnModificar.setActionCommand("personas.modificar");
                  ...
                  }
                  {
                     ...
                     btnEliminar.setActionCommand("personas.eliminar");
               ...
               }
               {
                  ...
                  pnlVentana.add(jScrollPane1, BorderLayout.CENTER);
                  {
                     ...
                     modeloDeTabla = new TableModelPersonas(this.almacen);

                     this.setResizable(true);
                     this.setIconifiable(true);
                     this.setMaximizable(true);
                     this.setSelected(true);
                     this.setTitle("Listado - Personas");
