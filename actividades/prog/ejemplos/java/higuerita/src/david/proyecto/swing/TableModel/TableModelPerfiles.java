...
// Comienza la clase
public class TableModelPerfiles extends AbstractTableModel {
   ...
   // Constructor
   public TableModelPerfiles(IAlmacen pAlmacen) {
      setAlmacen(pAlmacen);
   }
   ...
   public int getColumnCount() {
      return (new Perfiles()).getNumeroCampos();
   }
   ...
   public String getColumnName(int index) {
      return Perfiles.getNombreCampo(index);
   }
   ...
   public Object getValueAt(int fila, int col) {
      Perfiles reg = (Perfiles) datos.get(fila);
