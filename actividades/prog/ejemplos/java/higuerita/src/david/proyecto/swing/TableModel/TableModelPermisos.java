...
// Comienza la clase
public class TableModelPermisos extends AbstractTableModel {
   ...
   // Constructor
   public TableModelPermisos(IAlmacen pAlmacen) {
      setAlmacen(pAlmacen);
   }
   ...
   public int getColumnCount() {
      return (new Permisos()).getNumeroCampos();
   }
   ...
   public String getColumnName(int index) {
      return Permisos.getNombreCampo(index);
   }
   ...
   public Object getValueAt(int fila, int col) {
      Permisos reg = (Permisos) datos.get(fila);
