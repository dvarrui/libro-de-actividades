...
public class TableModelUsuarios extends AbstractTableModel {
   ...
   // Constructor
   public TableModelUsuarios(IAlmacen pAlmacen) {
      setAlmacen(pAlmacen);
   }
   ...
   public int getColumnCount() {
      return (new Usuarios()).getNumeroCampos();
   }
   ...
   public String getColumnName(int index) {
      return Usuarios.getNombreCampo(index);
   }
   ...
   public Object getValueAt(int fila, int col) {
      Usuarios reg = (Usuarios) datos.get(fila);
