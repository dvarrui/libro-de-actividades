...
import david.proyecto.swing.TableModel.TableModelCatalogos;

// Comienzo de la clase
public class FrmListadoCatalogos extends javax.swing.JInternalFrame implements ActionListener, IVentana {
   static final long serialVersionUID=1; //Para evitar Warnings

   // Atributos
   public static final String ID_VENTANA="catalogos.listado";
   ...
   private TableModelCatalogos modeloDeTabla;
   private IAlmacen almacen;
   
   // Constructor
   public FrmListadoCatalogos(IAlmacen pAlmacen) {
      super();
      setAlmacen(pAlmacen);
      initGUI();
   }
   ...
   public void actionPerformed(ActionEvent evt) {
      if (evt.getActionCommand().equals("catalogos.nuevo")) {
         // Abrir ventana Nuevo
      } else if (evt.getActionCommand().equals("catalogos.consultar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("catalogos.modificar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("catalogos.eliminar")) {
         this.setVisible(false);
            ...
            {
               {
                  ...
                  pnlVentana.add(pnlBotones, BorderLayout.SOUTH);
                  {
                     ...
                     btnNuevo.setActionCommand("catalogos.nuevo");
                  ...
                  }
                  {
                     ...
                     btnConsultar.setActionCommand("catalogos.consultar");
                  ...
                  }
                  {
                     ...
                     btnModificar.setActionCommand("catalogos.modificar");
                  ...
                  }
                  {
                     ...
                     btnEliminar.setActionCommand("catalogos.eliminar");
               ...
               }
               {
                  ...
                  pnlVentana.add(jScrollPane1, BorderLayout.CENTER);
                  {
                     ...
                     modeloDeTabla = new TableModelCatalogos(this.almacen);

                     this.setResizable(true);
                     this.setIconifiable(true);
                     this.setMaximizable(true);
                     this.setSelected(true);
                     this.setTitle("Listado - Catalogos");
