...
import david.proyecto.swing.TableModel.TableModelPermisos;

// Comienzo de la clase
public class FrmListadoPermisos extends javax.swing.JInternalFrame implements ActionListener, IVentana {
   static final long serialVersionUID=1; //Para evitar Warnings

   // Atributos
   public static final String ID_VENTANA="permisos.listado";
   ...
   private TableModelPermisos modeloDeTabla;
   private IAlmacen almacen;
   
   // Constructor
   public FrmListadoPermisos(IAlmacen pAlmacen) {
      super();
      setAlmacen(pAlmacen);
      initGUI();
   }
   ...
   public void actionPerformed(ActionEvent evt) {
      if (evt.getActionCommand().equals("permisos.nuevo")) {
         // Abrir ventana Nuevo
      } else if (evt.getActionCommand().equals("permisos.consultar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("permisos.modificar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("permisos.eliminar")) {
         this.setVisible(false);
            ...
            {
               {
                  ...
                  pnlVentana.add(pnlBotones, BorderLayout.SOUTH);
                  {
                     ...
                     btnNuevo.setActionCommand("permisos.nuevo");
                  ...
                  }
                  {
                     ...
                     btnConsultar.setActionCommand("permisos.consultar");
                  ...
                  }
                  {
                     ...
                     btnModificar.setActionCommand("permisos.modificar");
                  ...
                  }
                  {
                     ...
                     btnEliminar.setActionCommand("permisos.eliminar");
               ...
               }
               {
                  ...
                  pnlVentana.add(jScrollPane1, BorderLayout.CENTER);
                  {
                     ...
                     modeloDeTabla = new TableModelPermisos(this.almacen);

                     this.setResizable(true);
                     this.setIconifiable(true);
                     this.setMaximizable(true);
                     this.setSelected(true);
                     this.setTitle("Listado - Permisos");
