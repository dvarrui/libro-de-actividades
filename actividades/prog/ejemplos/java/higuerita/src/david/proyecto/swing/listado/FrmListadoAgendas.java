...
import david.proyecto.swing.TableModel.TableModelAgendas;

// Comienzo de la clase
public class FrmListadoAgendas extends javax.swing.JInternalFrame implements ActionListener, IVentana {
   static final long serialVersionUID=1; //Para evitar Warnings

   // Atributos
   public static final String ID_VENTANA="agendas.listado";
   ...
   private TableModelAgendas modeloDeTabla;
   private IAlmacen almacen;
   
   // Constructor
   public FrmListadoAgendas(IAlmacen pAlmacen) {
      super();
      setAlmacen(pAlmacen);
      initGUI();
   }
   ...
   public void actionPerformed(ActionEvent evt) {
      if (evt.getActionCommand().equals("agendas.nuevo")) {
         // Abrir ventana Nuevo
      } else if (evt.getActionCommand().equals("agendas.consultar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("agendas.modificar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("agendas.eliminar")) {
         this.setVisible(false);
            ...
            {
               {
                  ...
                  pnlVentana.add(pnlBotones, BorderLayout.SOUTH);
                  {
                     ...
                     btnNuevo.setActionCommand("agendas.nuevo");
                  ...
                  }
                  {
                     ...
                     btnConsultar.setActionCommand("agendas.consultar");
                  ...
                  }
                  {
                     ...
                     btnModificar.setActionCommand("agendas.modificar");
                  ...
                  }
                  {
                     ...
                     btnEliminar.setActionCommand("agendas.eliminar");
               ...
               }
               {
                  ...
                  pnlVentana.add(jScrollPane1, BorderLayout.CENTER);
                  {
                     ...
                     modeloDeTabla = new TableModelAgendas(this.almacen);

                     this.setResizable(true);
                     this.setIconifiable(true);
                     this.setMaximizable(true);
                     this.setSelected(true);
                     this.setTitle("Listado - Agendas");
