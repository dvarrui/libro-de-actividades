...
import david.proyecto.swing.TableModel.TableModelCitas;

// Comienzo de la clase
public class FrmListadoCitas extends javax.swing.JInternalFrame implements ActionListener, IVentana {
   static final long serialVersionUID=1; //Para evitar Warnings

   // Atributos
   public static final String ID_VENTANA="citas.listado";
   ...
   private TableModelCitas modeloDeTabla;
   private IAlmacen almacen;
   
   // Constructor
   public FrmListadoCitas(IAlmacen pAlmacen) {
      super();
      setAlmacen(pAlmacen);
      initGUI();
   }
   ...
   public void actionPerformed(ActionEvent evt) {
      if (evt.getActionCommand().equals("citas.nuevo")) {
         // Abrir ventana Nuevo
      } else if (evt.getActionCommand().equals("citas.consultar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("citas.modificar")) {
         this.setVisible(false);
      } else if (evt.getActionCommand().equals("citas.eliminar")) {
         this.setVisible(false);
            ...
            {
               {
                  ...
                  pnlVentana.add(pnlBotones, BorderLayout.SOUTH);
                  {
                     ...
                     btnNuevo.setActionCommand("citas.nuevo");
                  ...
                  }
                  {
                     ...
                     btnConsultar.setActionCommand("citas.consultar");
                  ...
                  }
                  {
                     ...
                     btnModificar.setActionCommand("citas.modificar");
                  ...
                  }
                  {
                     ...
                     btnEliminar.setActionCommand("citas.eliminar");
               ...
               }
               {
                  ...
                  pnlVentana.add(jScrollPane1, BorderLayout.CENTER);
                  {
                     ...
                     modeloDeTabla = new TableModelCitas(this.almacen);

                     this.setResizable(true);
                     this.setIconifiable(true);
                     this.setMaximizable(true);
                     this.setSelected(true);
                     this.setTitle("Listado - Citas");
