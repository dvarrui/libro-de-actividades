package david.gomera.scroll.v02;
...
public class Principal extends Canvas implements Stage, KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode()==38) {
			...
			fondoY=fondoY+10;
			if (fondoY > backgroundTile.getHeight())
				fondoY = 0;
			...
			fondoX=fondoX+10;
			if (fondoX > backgroundTile.getWidth())
				fondoX = 0;
		}
		
		System.out.println("Tecla:"+e.getKeyCode()+" X="+fondoX+" Y="+fondoY
	...
	public void paintWorld() {
		...
		g.drawImage(background, 0, 0, Stage.WIDTH, Stage.HEIGHT, 0,
				fondoY, Stage.WIDTH, fondoY + Stage.HEIGHT, this);
