...
* Vamos a necesitar las siguientes 3 MVs:
    1. Un servidor GNU/Linux OpenSUSE, con IP estática (172.18.XX.33).
    1. Un cliente GNU/Linux OpenSUSE, con IP estática (172.18.XX.34).
    1. Un cliente Windows7, con IP estática (172.18.XX.13).

![secret](./ssh-secret.jpeg)

En OpenSUSE podemos configurar el interfaz de red modificando directamente el fichero
de configuración o usando el interfaz `yast`. Veamos un ejemplo de cómo sería 
el fichero de configuración del interfaz de red `enp2s0` en OpenSUSE.
El fichero sería `/etc/sysconfig/network/ifcfg-enp2s0`. 
